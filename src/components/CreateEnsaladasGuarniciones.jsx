  ...
  return (
    ...
    <div className='w-full h-full md:h-dvh md:py-2 flex items-start justify-center'>
      ...
      <div className="rounded-2xl h-[6rem] flex items-center justify-around gap-1 text-[#769164]">
                ...
                <p className='w-[8rem]'>ENSALADAS Y GUARNICIONES</p>  <LuSalad /> 
              </div>
              <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <form onSubmit={handleSubmit(submitForm)} className="space-y-3">
                  ...
                  >
                    <option value=''></option>
                    <option className='text-[#4b5d3f]' value='ensaladas'>Ensaladas</option>
                    <option className='text-[#4b5d3f]' value='guarniciones'>Guarniciones</option>
                  </select>
...
export default CreateEnsaladasGuarniciones;