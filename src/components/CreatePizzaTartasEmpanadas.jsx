      ...
      <div className='w-full h-full md:h-dvh md:py-2 flex items-start justify-center'>
        <div className="bg-[#f9eae6] w-[80%] md:w-[20rem] rounded-2xl py-4 px-6 lg:px-8">
          <div className="rounded-2xl h-[6rem] flex items-center justify-around gap-1 text-[#769164]">
            ...
            <p className='w-[8rem]'>PIZZAS TARTAS Y EMPNADAS</p><LuPizza />
          </div>
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <form onSubmit={handleSubmit(submitForm)} className="space-y-3">
              ...
              >
                <option value=''></option>
                <option className='text-[#4b5d3f]' value='pizzas'>Pizzas</option>
                <option className='text-[#4b5d3f]' value='tartas'>Tartas</option>
                <option className='text-[#4b5d3f]' value='empanadas'>Empanadas</option>
              </select>
...
export default CreatePizzaTartasEmpanadas;